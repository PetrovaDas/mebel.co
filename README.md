...
* описала логику и вёрстку страниц регистрации, логина, сброса пароля, редактирования профиля: ФИО, привязанной к аккаунта почты и адреса доставки; 
* реализовала асинхронные GET- и POST-запросы к API;
* проработала авторизованные и неавторизованные состояния;
* сдеала user friendly валидацию форм с использованием библиотеки react-hook-form.
